...
| P1-12 | build | Remove channel/deck from the rack (UI affordance + republish; vanished-source preserve-don't-drop posture stays intact). Small; before or at P1-G1 re-check | todo | seeded by P1-AUDIT |
