...
> (earmarked, no rows). Cross-phase order: ~~P3-X2~~ → ~~P3-F3~~ (both done
> 2026-07-30) → P3.5-E3 → P6-4..AUDIT → P7 → P8 → P9 → (P10); P3.5-E1 is
> user-fed in parallel.
...
>
> **Global order across phases:** ~~P3-X2~~ → ~~P3-F3~~ (both done 2026-07-30) →
> **P3.5-E3** (hoisted defect) → P6-4 → P6-5 → P6-6 → P6-AUDIT →
