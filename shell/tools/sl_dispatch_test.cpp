...
int main() {
    ...
    // getCapabilities — the handshake. schemaVersion must be scoopy's (88), or
    ...
    // aspirational ones.
    {
        ...
        CHECK((int) caps.getProperty("schemaVersion", 0) == 88); // scoopy SCHEMA_VERSION
        ...
        CHECK((int) capabilities().getProperty("schemaVersion", 0) == 88);
    }
