...
export const COMMANDS = {
  ...
  slTape: {
    params: z.object({
      ...
      /** scratchStart: which figure, as a POSITION in the table generated from
          `slengine/scratch-techniques.json`. The index is the wire and both
          sides are emitted from that one authority (`scratch:check`). */
      technique: z.number().int().min(0).optional(),
