    ...
    params: z.object({
      action: z.enum([
        ...
        /** TURNTABLISM SCRATCH (v101, docs/specs/scratching.md). A tempo-locked
            ...
            ignores `tape`. */
        "scratchStart", "scratchSet", "scratchStop", "scratchTempo",
